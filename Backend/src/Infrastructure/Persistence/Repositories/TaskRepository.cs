...
public class TaskRepository : ITaskRepository
{
    ...
    public async Task<List<TaskDto>> GetAllByUserAsync(string userId, CancellationToken ct = default)
    {
        return await _context.Tasks
            ...
            .Select(t => new TaskDto(t.Id, t.Title, t.Description, t.Status, t.ProjectId, t.CreatedAt))
            .ToListAsync(ct);
    }
    ...
    public async Task<TaskDto> GetByIdAsync(Guid id, CancellationToken ct = default)
    {
        ...
        return new TaskDto(task.Id, task.Title, task.Description, task.Status, task.ProjectId, task.CreatedAt);
    }
