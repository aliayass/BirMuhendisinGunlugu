...
public interface INoteRepository
{
    ...
    Task<NoteDto> CreateAsync(string title, string content, Guid? parentId, string userId, CancellationToken ct = default);
    Task<NoteDto> UpdateAsync(Guid id, string title, string content, string userId, CancellationToken ct = default);
